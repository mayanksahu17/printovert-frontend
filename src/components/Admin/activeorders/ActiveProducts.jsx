...
import Button from '../../button/Button'
  ...
  const ActiveProducts = ({ product ,handleActive,handleReject }) => {
...
<Button className='ml-20' children={"Deliver"} onClick={handleActive} />
<Button className='' children={"Reject"} onClick={handleReject} />
